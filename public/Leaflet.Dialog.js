L.Control.Dialog = L.Control.extend({
  ...
  initialize: function(options) {
    ...
    // Deep copy arrays to prevent sharing between instances
    this.options.size = [this.options.size[0], this.options.size[1]];
    this.options.minSize = [this.options.minSize[0], this.options.minSize[1]];
    this.options.maxSize = [this.options.maxSize[0], this.options.maxSize[1]];
    this.options.anchor = [this.options.anchor[0], this.options.anchor[1]];
